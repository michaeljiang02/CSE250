...
int main() {
    ...
    /**
     * Uncomment the preferred sort method (sort() is insertion sort and recursiveSort()
     * is selection sort) and comment the other one and rerun the program.
     * Warning: both methods are extremely slow and inefficient.
     */
